...
const UserGraphSection: React.FC = () => {
  ...
  const chartData: ChartDataPoint[] = [
    ...
    { name: 'Apr', current: 25000, average: 10000 },
    { name: 'May', current: 20000, average: 14000 },
    { name: 'Jun', current: 19000, average: 16000 },
    { name: 'Jul', current: 22000, average: 20000 },
  ];
      ...
      <View style={styles.trafficContainer}>
        ...
        <View style={styles.metricsGrid}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
            ...
            <Text style={{ fontSize: 14, color: '#111827', fontWeight: '600' }}>84.29</Text>
          </View>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
